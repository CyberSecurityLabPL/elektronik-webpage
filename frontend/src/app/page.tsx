        ...
        <div className="px-4 flex flex-col justify-center gap-8 lg:flex-row xl:justify-around w-full items-center h-[calc(100vh-8rem)] bg-hero-squares bg-no-repeat   ">
          <div className="flex flex-col justify-center  items-center  my-4">
                  ...
                  <div className="flex flex-col py-4 ">
                      <h1 className="text-4xl px-4 lg:text-6xl xl:text-7xl text-center lg:text-left font-extrabold py-2 bg-gradient-to-r from-primary  to-foreground inline-block text-transparent bg-clip-text">Witaj w Elektroniku</h1>
