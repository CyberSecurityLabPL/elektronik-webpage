...
export default function MobileAppSection() {
  ...
  return (
    <div className="relative my-24 flex w-full flex-col items-center justify-center gap-2 bg-primary px-4 py-8 hc:bg-background-accent sm:px-8 md:my-72 lg:flex-row lg:gap-32">
      <div className="absolute left-0 top-0 -z-10 aspect-[1713/319] w-full -translate-y-[65%]">
        <Image
          src={
            isHc
      ...
      <div className="flex h-full max-w-[800px] flex-col ml-0 sm:ml-16 items-start justify-center gap-12 text-background">
        <div className="flex flex-col items-center lg:items-start gap-4 ">
          <div className="text-3xl text-center font-semibold text-white sm:text-4xl xl:text-5xl">
            Chcesz być na bieżąco?
          </div>
          <div className="text-sm text-center lg:text-left text-background/80 hc:text-white/80 sm:text-base xl:text-lg">
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="text-xl text-center font-semibold text-white sm:text-lg xl:text-xl">
          ...
          />
          <div className=" w-full text-xs text-center lg:text-left text-white sm:text-sm xl:text-base">
            oraz wiele więcej!
          </div>
        </div>
        <DownloadsAndQr />
...
const BulletPoint = ({
  ...
  return (
    <div className="flex items-start sm:items-center justify-center gap-2">
      <div className="flex size-6 pt-2 sm:pt-0 items-center justify-center sm:size-7">
        <CircleCheckBig className="size-6 stroke-[#032666] hc:stroke-primary sm:size-7" />
      </div>
      <div>
        <span className="text-sm font-semibold text-white sm:text-sm xl:text-base">
          {title}
        </span>
        <span className="text-sm text-white sm:text-sm xl:text-base">{` - ${description}`}</span>
      </div>
    </div>
  )
}
