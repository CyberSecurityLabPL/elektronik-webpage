...
export default function Faq() {
    return (
        <div className='w-full h-screen flex justify-center items-center'>
            <Card className='w-4/5 h-fit z-50 right-0'>
                <CardHeader>
                    ...
                    <div className='w-full '>
                        <Accordion type="single" collapsible>
                            ...
                            <AccordionItem value="item-2">
                                <AccordionTrigger>Czy szkoła przyjmuje uczniów z potrzebami specjalnymi?</AccordionTrigger>
                                <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-3">
                                <AccordionTrigger>Czy jest w szkole psycholog ?</AccordionTrigger>
                                <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-4">
                                <AccordionTrigger>Jak oceniacie atmosferę w szkołach i przyjemność nauki?</AccordionTrigger>
                                <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-5">
                                <AccordionTrigger>Czy szkoła Elektronik jest tylko dla chłopaków?</AccordionTrigger>
                                <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                                </AccordionContent>
                            </AccordionItem>
