...
export default function Benefits() {
    ...
    <div className='   h-fit flex flex-col justify-center items-center'>
        <h1 className='text-4xl text-center font-semibold text-slate-800 py-8 px-2'>Dlaczego warto wybrać Elektrona?</h1>
        <div className='grid w-3/4 grid-cols-1 grid-rows-4 lg:grid-cols-6 lg:grid-rows-2 gap-4'>
            <Card variant={'glass'} className="lg:col-span-2">
                <CardHeader  className='pb-1'>
                    <CardTitle className='text-xl sm:text-2xl md:text-3xl'>Świetna Lokalizacja</CardTitle>
                </CardHeader>
            ...
            <Card  className="lg:col-span-4  flex relative ">
                ...
                <div className=' px-0 absolute right-0 z-20 flex flex-col items-end'>
                    <CardHeader className='pb-1 '>
                        <CardTitle className='text-xl sm:text-2xl md:text-3xl text-right'>Świeżo wyremontowana</CardTitle>
                    </CardHeader>
            ...
            <Card  className="flex relative lg:col-span-4">
                <div className='w-3/4 py-4 flex flex-col justify-end absolute left-0 bottom-0  z-20'>
                    <CardHeader className='pb-1 '>
                        <CardTitle className='text-xl sm:text-2xl md:text-3xl'>Przyjazna atmosfera</CardTitle>
                    </CardHeader>
            ...
            <Card variant={'glass'} className="lg:col-span-2">
                <CardHeader className='pb-1'>
                    <CardTitle className='text-xl sm:text-2xl md:text-3xl'>Ciekawe eventy</CardTitle>
                </CardHeader>
